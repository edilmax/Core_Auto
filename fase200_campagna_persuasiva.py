...
# ⛔ L'INTERVALLO RESTA UNICO, ED E' UNA DECISIONE PRESA COL FONDATORE (2026-08-20).
# Il 2026-08-20 l'avevo spezzato in undici blocchi per far tacere `py/overly-large-range` di
# CodeQL. Misurato sul commit vero: quella regola e' passata **da 1 allarme a 10**, perche'
# CodeQL li conta uno per uno. Il conto degli allarmi non e' il punteggio da inseguire, ma
# dieci righe di rumore su una regola di **leggibilita'** (non di sicurezza) sporcano la lista
# dove un giorno dovra' spiccare una cosa vera. Quindi si torna a uno solo, e l'allarme che
# resta e' dichiarato e accettato, non ignorato.
# ⛔ CIO' CHE VIENE FILTRATO NON SI TOCCA SENZA ACCORGERSENE: lo sorveglia
# `test_il_filtro_delle_emoji_copre_ESATTAMENTE_gli_stessi_caratteri`, che attraversa TUTTO
# lo spazio Unicode e confronta carattere per carattere (3538 in tutto). Chiunque riscriva
# questa classe — per stile, per far tacere un analizzatore, per sbaglio — lo vede subito.
_EMOJI = re.compile(
