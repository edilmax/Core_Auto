...
ETICHETTE_SERVIZI: Dict[str, Dict[str, str]] = {
    "wifi": {"en": "WiFi", "it": "Wi-Fi", "es": "Wifi", "fr": "Wifi", "de": "WLAN"},
    "parcheggio": {"en": "Parking", "it": "Parcheggio", "es": "Aparcamiento",
                   "fr": "Parking", "de": "Parkplatz"},
    "piscina": {"en": "Pool", "it": "Piscina", "es": "Piscina", "fr": "Piscine",
                "de": "Pool"},
    "aria_condizionata": {"en": "Air conditioning", "it": "Aria condizionata",
                          "es": "Aire acondicionado", "fr": "Climatisation",
                          "de": "Klimaanlage"},
    "cucina": {"en": "Kitchen", "it": "Cucina", "es": "Cocina", "fr": "Cuisine",
               "de": "Kueche"},
    "lavatrice": {"en": "Washing machine", "it": "Lavatrice", "es": "Lavadora",
                  "fr": "Lave-linge", "de": "Waschmaschine"},
    "animali_ammessi": {"en": "Pets allowed", "it": "Animali ammessi",
                        "es": "Se admiten mascotas", "fr": "Animaux acceptes",
                        "de": "Haustiere erlaubt"},
    "colazione": {"en": "Breakfast", "it": "Colazione", "es": "Desayuno",
                  "fr": "Petit-dejeuner", "de": "Fruehstueck"},
    "vista_mare": {"en": "Sea view", "it": "Vista mare", "es": "Vistas al mar",
                   "fr": "Vue mer", "de": "Meerblick"},
    "parcheggio_disabili": {"en": "Accessible parking", "it": "Parcheggio disabili",
                            "es": "Aparcamiento accesible", "fr": "Parking handicape",
                            "de": "Behindertenparkplatz"},
    "check_in_24h": {"en": "24h check-in", "it": "Check-in 24h", "es": "Check-in 24h",
                     "fr": "Check-in 24h", "de": "24h Check-in"},
    "riscaldamento": {"en": "Heating", "it": "Riscaldamento", "es": "Calefaccion",
                      "fr": "Chauffage", "de": "Heizung"},
}

# Stati (prenotazione/disponibilita') -> lingua -> testo.
ETICHETTE_STATI: Dict[str, Dict[str, str]] = {
    "confermata": {"en": "Confirmed", "it": "Confermata", "es": "Confirmada",
                   "fr": "Confirmee", "de": "Bestaetigt"},
    "rifiutata": {"en": "Rejected", "it": "Rifiutata", "es": "Rechazada",
                  "fr": "Refusee", "de": "Abgelehnt"},
    "pieno": {"en": "Sold out", "it": "Pieno", "es": "Completo", "fr": "Complet",
              "de": "Ausgebucht"},
    "chiuso": {"en": "Closed", "it": "Chiuso", "es": "Cerrado", "fr": "Ferme",
               "de": "Geschlossen"},
}
