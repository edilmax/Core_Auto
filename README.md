...
├── fase*.py                    137 moduli del motore (uno per funzione — indice in REGISTRO_INGEGNERIA.md)
├── test_*.py                   323 file di test (la suite INTERA deve essere verde prima di ogni deploy)
