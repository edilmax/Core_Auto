...
├── fase*.py                    154 moduli del motore (uno per funzione — indice in REGISTRO_INGEGNERIA.md)
├── test_*.py                   422 file di test (la suite INTERA deve essere verde prima di ogni deploy)
