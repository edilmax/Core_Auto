...
ETICHETTE_UI: Dict[str, Dict[str, str]] = {
    ...
    "fiducia_linea": {"it": "Prezzo firmato · Soldi in garanzia · 0% per te", "en": "Signed price · Money in escrow · 0% for you", "es": "Precio firmado · Dinero en garantía · 0% para ti", "fr": "Prix signé · Argent sous garantie · 0% pour vous", "de": "Signierter Preis · Geld in Treuhand · 0% für dich", "pt": "Preço assinado · Dinero em garantia · 0% para você", "ja": "署名価格 · 資金保全 · あなたは0%", "zh": "签名价格 · 资金托管 · 对您0%"},
