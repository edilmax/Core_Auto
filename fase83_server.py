...
ETICHETTE_UI: Dict[str, Dict[str, str]] = {
    ...
    "accedi_registrati": {"it": "Accedi o Registrati", "en": "Log in or Sign up",
                          "es": "Entrar o Registrarse", "fr": "Connexion ou Inscription",
                          "de": "Anmelden oder Registrieren"},
    "accedi": {"it": "Accedi", "en": "Log in", "es": "Entrar", "fr": "Connexion",
               "de": "Anmelden"},
    "registrati": {"it": "Registrati", "en": "Sign up", "es": "Registrarse",
                   "fr": "S'inscrire", "de": "Registrieren"},
    "esci": {"it": "Esci", "en": "Log out", "es": "Salir", "fr": "Deconnexion",
             "de": "Abmelden"},
    "miei_alloggi": {"it": "I miei alloggi", "en": "My listings", "es": "Mis alojamientos",
                     "fr": "Mes logements", "de": "Meine Unterkunfte"},
    "invita_host": {"it": "Invita altri host", "en": "Invite other hosts",
                    "es": "Invita anfitriones", "fr": "Inviter des hotes",
                    "de": "Andere Gastgeber einladen"},
    "link_diretto": {"it": "Il tuo link prenotazione diretta", "en": "Your direct booking link",
                     "es": "Tu enlace de reserva directa", "fr": "Votre lien de reservation directe",
                     "de": "Dein Direktbuchungs-Link"},
    "messaggi_ospite": {"it": "Messaggi con l'ospite", "en": "Messages with the guest",
                        "es": "Mensajes con el huesped", "fr": "Messages avec le voyageur",
                        "de": "Nachrichten mit dem Gast"},
    "prezzo_dinamico": {"it": "Prezzo dinamico suggerito", "en": "Suggested dynamic price",
                       "es": "Precio dinamico", "fr": "Prix dynamique", "de": "Dynamischer Preis"},
    # voucher
