...
ETICHETTE_UI: Dict[str, Dict[str, str]] = {
    ...
    # --- hero / slogan ---
    "hero_titolo": {"it": "Per noi,", "en": "For us,", "es": "Para nosotros,", "fr": "Pour nous,", "de": "Bei uns,", "pt": "Para nós,", "ja": "私たちには、", "zh": "对我们来说，"},
    "hero_titolo2": {"it": "il VIP sei tu.", "en": "you are the VIP.", "es": "el VIP eres tú.", "fr": "le VIP, c'est vous.", "de": "bist du der VIP.", "pt": "o VIP é você.", "ja": "VIPはあなたです。", "zh": "VIP就是你。"},
    "hero_sub": {"it": "Alloggi certificati · prezzo trasparente · cancellazione gratuita", "en": "Certified stays · transparent price · free cancellation", "es": "Alojamientos certificados · precio transparente · cancelación gratuita", "fr": "Logements certifiés · prix transparent · annulation gratuite", "de": "Zertifizierte Unterkünfte · transparenter Preis · kostenlose Stornierung", "pt": "Acomodações certificadas · preço transparente · cancelamento grátis", "ja": "認証済みの宿泊施設 · 明確な価格 · 無料キャンセル", "zh": "认证住宿 · 透明价格 · 免费取消"},
    ...
    "fiducia_linea": {"it": "Prezzo garantito · denaro protetto · 0% di commissioni per te", "en": "Guaranteed price · protected money · 0% fees for you", "es": "Precio garantizado · dinero protegido · 0% de comisiones para ti", "fr": "Prix garanti · argent protégé · 0% de commissions pour vous", "de": "Garantierter Preis · geschütztes Geld · 0% Gebühren für dich", "pt": "Preço garantido · dinheiro protegido · 0% de taxas para você", "ja": "価格保証 · 資金保護 · 手数料0%", "zh": "价格保证 · 资金受保护 · 对您0%手续费"},
    "filtri_av": {"it": "Filtri avanzati", "en": "Advanced filters", "es": "Filtros avanzados", "fr": "Filtres avancés", "de": "Erweiterte Filter", "pt": "Filtros avançados", "ja": "詳細フィルタ", "zh": "高级筛选"},
    ...
    "chat_voce_title": {"it": "Ditta il messaggio a voce", "en": "Dictate your message", "es": "Dicta tu mensaje", "fr": "Dictez votre message", "de": "Nachricht diktieren", "pt": "Dite sua mensagem", "ja": "メッセージを音声入力", "zh": "语音输入消息"},
    "chat_voce_no": {"it": "La dettatura non e' disponibile ora: puoi scrivere il messaggio a mano.", "en": "Dictation isn't available right now: you can type your message instead.", "es": "El dictado no está disponible ahora: puedes escribir el mensaje a mano.", "fr": "La dictée n'est pas disponible pour le moment : vous pouvez écrire votre message.", "de": "Das Diktat ist gerade nicht verfügbar: du kannst die Nachricht einfach tippen.", "pt": "A ditagem não está disponível agora: você pode escrever a mensagem à mão.", "ja": "音声入力は現在利用できません。手入力でメッセージを書けます。", "zh": "语音输入目前不可用：您可以手动输入消息。"},
    "chat_voce_no_perm": {"it": "Il microfono è bloccato: consenti l'accesso dall'icona del lucchetto nella barra degli indirizzi, poi riprova.", "en": "The microphone is blocked: allow access from the padlock icon in the address bar, then try again.", "es": "El micrófono está bloqueado: permite el acceso desde el candado de la barra de direcciones e inténtalo de nuevo.", "fr": "Le micro est bloqué : autorisez l'accès depuis le cadenas dans la barre d'adresse, puis réessayez.", "de": "Das Mikrofon ist gesperrt: erlaube den Zugriff über das Schloss-Symbol in der Adressleiste und versuche es erneut.", "pt": "O microfone está bloqueado: permita o acesso pelo cadeado na barra de endereço e tente de novo.", "ja": "マイクがブロックされています。アドレスバーの鍵アイコンから許可して、もう一度お試しください。", "zh": "麦克风被阻止：请点击地址栏的锁形图标允许访问，然后重试。"},
    "chat_chiudi_title": {"it": "Chiudi", "en": "Close", "es": "Cerrar", "fr": "Fermer", "de": "Schließen", "pt": "Fechar", "ja": "閉じる", "zh": "关闭"},
    # --- stato vuoto / lista d'attesa ---
    "empty_titolo": {"it": "Fase di test: servizio migliore, più risparmio", "en": "Test phase: a better service, more savings", "es": "Fase de pruebas: mejor servicio, más ahorro", "fr": "Phase de test : un meilleur service, plus d'économies", "de": "Testphase: besserer Service, mehr Ersparnis", "pt": "Fase de testes: melhor serviço, mais economia", "ja": "テスト期間中：より良いサービスと、もっとお得に", "zh": "测试阶段：更好的服务，更多实惠"},
    "empty_lascia": {"it": "Stiamo affinando tutto per offrirti un servizio migliore e prezzi più bassi. Lascia la tua email: ti avvisiamo appena apriamo nella tua città e ricevi subito uno sconto di 5 € sulla tua prima prenotazione.", "en": "We're fine-tuning everything to bring you a better service and lower prices. Leave your email: we'll notify you as soon as we open in your city and you'll get a 5 € discount on your first booking.", "es": "Estamos puliendo todo para ofrecerte un mejor servicio y precios más bajos. Deja tu correo: te avisamos en cuanto abramos en tu ciudad y tendrás un descuento de 5 € en tu primera reserva.", "fr": "Nous peaufinons tout pour vous offrir un meilleur service et des prix plus bas. Laissez votre e-mail : nous vous prévenons dès l'ouverture dans votre ville et vous obtenez 5 € de réduction sur votre première réservation.", "de": "Wir feilen an allem, um dir einen besseren Service und niedrigere Preise zu bieten. Hinterlasse deine E-Mail: Wir benachrichtigen dich, sobald wir in deiner Stadt öffnen, und du erhältst 5 € Rabatt auf deine erste Buchung.", "pt": "Estamos aprimorando tudo para oferecer um serviço melhor e preços mais baixos. Deixe o seu e-mail: avisamos assim que abrirmos na sua cidade e você ganha 5 € de desconto na primeira reserva.", "ja": "より良いサービスと低い価格のため、今は調整中です。メールアドレスを登録してください。あなたの街でオープンしたらすぐお知らせし、初回予約に使える5ユーロの割引を差し上げます。", "zh": "我们正在精心打磨，为你带来更好的服务和更低的价格。留下你的邮箱：你所在城市一开放我们就通知你，并立即获得首笔预订5欧元的优惠。"},
    ...
    "sei_host": {"it": "Sei un host? Cosa aspetti a farne parte?", "en": "Are you a host? Why wait to join?", "es": "¿Eres anfitrión? ¿A qué esperas para unirte?", "fr": "Vous êtes hôte ? Pourquoi attendre pour nous rejoindre ?", "de": "Du bist Gastgeber? Worauf wartest du noch?", "pt": "É anfitrião? O que está esperando para fazer parte?", "ja": "ホストですか？参加するなら今がその時です。", "zh": "你是房东吗？还在等什么，快来加入吧！"},
    "recensioni_verifica": {"it": "Solo ospiti che hanno pagato e soggiornato possono recensire — verificato dal sistema", "en": "Only guests who paid and stayed can review — verified by the system", "es": "Solo los huéspedes que pagaron y se alojaron pueden opinar — verificado por el sistema", "fr": "Seuls les voyageurs ayant payé et séjourné peuvent laisser un avis — vérifié par le système", "de": "Nur Gäste, die bezahlt und übernachtet haben, können bewerten — vom System überprüft", "pt": "Apenas hóspedes que pagaram e ficaram podem avaliar — verificado pelo sistema", "ja": "支払って宿泊したゲストだけがレビューできます — システムが確認済み", "zh": "只有已支付并入住的房客才能评价 — 系统已验证"},
