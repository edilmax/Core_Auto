...
> Software: ~115 moduli fase (→162), 1875 test verdi, zero dipendenze esterne, su github.com/edilmax/Core_Auto.
>
...
6. **Testato fino in fondo**: 1875 test verdi, zero regressioni, ogni funzione verificata
