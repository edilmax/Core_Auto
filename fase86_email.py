...
_TR = {
    ...
    "b_commissioni": {"it": "Commissione <b>0% per i primi 90 giorni</b>, poi 8% fino a un anno, poi 10% dal marketplace. Sempre solo 5% sul tuo link diretto. L'ospite paga 0%. Nessun canone e nessun costo fisso: l'unica cosa sempre dovuta è una tariffa tecnica del 5% + 0,25 € a prenotazione (7% + 0,25 € sugli annunci in valuta diversa dall'euro), che copre il costo di incassare e di bonificarti.",
                      "en": "Commission <b>0% for the first 90 days</b>, then 8% up to one year, then 10% from the marketplace. Always just 5% on your direct link. The guest pays 0%. No subscription and no fixed cost: the only thing always due is a technical fee of 5% + EUR 0.25 per booking (7% + EUR 0.25 for listings priced in a currency other than the euro), covering the cost of collecting and paying out.",
                      "es": "Comisión <b>0% los primeros 90 días</b>, luego 8% hasta un año, después 10% desde el marketplace. Siempre solo 5% en tu enlace directo. El huésped paga 0%. Sin cuota ni coste fijo: lo único siempre debido es una tarifa técnica del 5% + 0,25 € por reserva (7% + 0,25 € en los anuncios con precio en moneda distinta del euro), que cubre el coste de cobrar y de pagarte.",
                      "fr": "Commission <b>0 % les 90 premiers jours</b>, puis 8 % jusqu'à un an, puis 10 % via la marketplace. Toujours 5 % seulement sur votre lien direct. Le voyageur paie 0 %. Aucun abonnement ni coût fixe : la seule chose toujours due est des frais techniques de 5 % + 0,25 € par réservation (7 % + 0,25 € pour les annonces libellées dans une devise autre que l'euro), qui couvrent le coût d'encaisser et de vous verser.",
                      "de": "Provision <b>0 % in den ersten 90 Tagen</b>, dann 8 % bis zu einem Jahr, dann 10 % über den Marktplatz. Über Ihren Direktlink immer nur 5 %. Der Gast zahlt 0 %. Keine Gebühr und keine Fixkosten: stets fällig ist nur ein technisches Entgelt von 5 % + 0,25 € je Buchung (7 % + 0,25 € bei Inseraten, die nicht in Euro ausgezeichnet sind), das die Kosten für Einzug und Auszahlung deckt.",
                      "pt": "Comissão <b>0% nos primeiros 90 dias</b>, depois 8% até um ano, depois 10% via marketplace. No teu link direto, sempre só 5%. O hóspede paga 0%. Sem mensalidade e sem custo fixo: a única coisa sempre devida é uma taxa técnica de 5% + 0,25 € por reserva (7% + 0,25 € nos anúncios com preço em moeda diferente do euro), que cobre o custo de cobrar e de te pagar.",
                      "ja": "手数料は<b>最初の90日間は0%</b>、その後1年まで8%、以降マーケットプレイス経由で10%。あなたの直接リンクなら常に5%のみ。ゲストの負担は0%。月額も固定費もありません。常に発生するのは1件あたり5% + 0,25 ユーロの技術手数料のみ（ユーロ以外の通貨で価格を設定した掲載は7% + 0,25 ユーロ）で、これは入金と送金の費用を賄います。",
                      "zh": "佣金<b>前 90 天为 0%</b>，之后至一年为 8%，再之后经市场为 10%。通过您的专属直连链接始终仅 5%。房客支付 0%。无月费、无固定费用：唯一始终收取的是每笔 5% + 0,25 欧元的技术服务费（以欧元以外货币定价的房源为 7% + 0,25 欧元），用于支付收款与付款的成本。"},
    # --- promemoria check-in ---
